                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        //condition to allow a voter to vote only once.
                                        if($isVoteCasted > 0)
                                        {
                                            ...
                                            {
                                                ?>
                                                    <!-- <img src="../assets/images/alreadyVoted.png" width="100px"> -->
                                                     <button class="btn btn-md btn-danger">Already Voted</button>
...
<script>
    //CastVote function is used to fetch data when user clicks the vote button 
    const CastVote = (election_id,customer_id,voters_id) =>
    {
        //ajax call is used to parse data without reloading the page.
        $.ajax({
            type:"POST",
